/**
    ...
    `CFFGLPluginInfo` that Scopes.cpp registers at static-initialisation time.
    ...
    which build it is.
        ...
        strings Scopes.bundle/Contents/MacOS/Scopes | grep scopes
*/

extern "C" const char* ScopesBuildStamp()
{
	return "resolume-scopes " SCOPES_VERSION " built " __DATE__ " " __TIME__;
}
