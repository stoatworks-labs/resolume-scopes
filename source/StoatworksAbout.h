/*
 * Stoatworks Labs - About window data for Scopes.
 *
...
{
    inline constexpr auto name = "Scopes";
    inline constexpr auto slug = "resolume-scopes";
    inline constexpr auto hook = "Video scopes for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/resolume-scopes/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/resolume-scopes/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/resolume-scopes";
