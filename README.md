...
**[v1.0.5](https://github.com/stoatworks-labs/resolume-scopes/releases/tag/v1.0.5)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`resolume-scopes-1.0.5-macos-universal.dmg`](https://github.com/stoatworks-labs/resolume-scopes/releases/download/v1.0.5/resolume-scopes-1.0.5-macos-universal.dmg) | 223 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`resolume-scopes-1.0.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/resolume-scopes/releases/download/v1.0.5/resolume-scopes-1.0.5-windows-x86_64-setup.exe) | 223 KB |
| x64 · .zip archive | [`resolume-scopes-windows-x86_64.zip`](https://github.com/stoatworks-labs/resolume-scopes/releases/latest/download/resolume-scopes-windows-x86_64.zip) | 118 KB |
